...
//         `http://100.25.233.42:7013/api/admin/admin/deleteproduct/${delData._id}`
//       );
//       if (res) {
...
//     try {
//       let res = await axios.get("http://100.25.233.42:7013/api/admin/getcategory");
//       if (res.status === 200) {
...
//         "http://100.25.233.42:7013/api/admin/admin/updateGalleryImages",
//         formData,
//         {
//           headers: { "Content-Type": "multipart/form-data" },
//         }
...
//     try {
//       const config = {
//         url: `http://100.25.233.42:7013/api/admin/admin/DeleteGalleryimage/${Data?._id}`,
//         method: "delete",
//         baseURL: "http://100.25.233.42:7013/api/",
...
//                       <div>
//                         <img
//                           src={`http://100.25.233.42:7013/Products/${items.productimage[0]?.image}`}
//                           alt="img"
